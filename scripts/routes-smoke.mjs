...
const dashboardPage = fs.readFileSync(path.join(root.pathname,'app/dashboard/page.tsx'),'utf8');
...
assert.match(dashboardPage, /isPermissionAndClassificationAuthorized/);
...
assert.match(routeAuthorization, /resolveAuthorizedModuleActions/);
assert.match(moduleRoute, /isModuleRouteAuthorized/);
assert.match(moduleRoute, /resolveAuthorizedModuleActions/);
