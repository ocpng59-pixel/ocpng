...
const requiredFiles = [
  ...
  'components/app-shell.tsx','components/sidebar.tsx','components/sign-out-control.tsx','components/module-landing.tsx','lib/config/module-pages.ts','lib/supabase/browser.ts','lib/supabase/server.ts','lib/rbac/authorized-navigation.ts'
];
